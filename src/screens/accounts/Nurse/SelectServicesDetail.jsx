...
const SelectServicesDetail = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.chooseServicesView}>
        ...
        <View style={{flex:1,width:"100%",justifyContent:"flex-end",alignItems:"center",paddingLeft:'2%',paddingRight:"2%",paddingBottom:'4%'}}>
          <TouchableOpacity onPress={()=>navigation.navigate('NursingDrawerNavigation')} style={{height:'16%',width:"100%",borderRadius:10,justifyContent:"center",alignItems:'center',backgroundColor:themes.green}}>
...
export default SelectServicesDetail
